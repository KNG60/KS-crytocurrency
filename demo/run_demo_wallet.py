...
def main():
    ...
    print("  4. show-priv           - Wyswietlenie klucza prywatnego")
    print("  5. show-priv (zle)     - Proba z blednym haslem (blad)")
    print("  6. delete              - Usuniecie konta")
    print("  7. list (po usunieciu) - Wyswietlenie listy po usunieciu")
    print("  8. delete (brak konta) - Operacja na nieistniejacym koncie (blad)")
    print("Haslo uzyte w demo: " + DEMO_PASSWORD)
    print("#" * 70 + "\n")
    cleanup_demo_db()
    print("\n\n### 1. SHOW HELP ###")
    ...
    print(stdout)
    print(f"Exit Code: {proc.returncode}")
    print("\n\n### 5. SHOW PRIVATE KEY WITH WRONG PASSWORD (Should Fail) ###")
    cmd = f"python run_wallet.py show-priv alice"
    print(f"COMMAND: {cmd}")
    ...
    print(stdout)
    print(f"Exit Code: {proc.returncode}")
    print("\n\n### 6. DELETE ACCOUNT (charlie) ###")
    run_wallet_command("delete charlie")
    print("\n\n### 7. LIST ACCOUNTS AFTER DELETION ###")
    run_wallet_command("list")
    print("\n\n### 8. TRY OPERATION ON NON-EXISTENT ACCOUNT (Should Fail) ###")
    run_wallet_command("delete nonexistent")
    print("\n\n" + "#" * 70)
    print("# DEMO COMPLETE")
    print("#" * 70)
